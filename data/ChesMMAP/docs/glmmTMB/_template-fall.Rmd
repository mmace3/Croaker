...
```{r model-{{mod_num}}-fall-fit-plots, fig.cap = paste0("DHARMa output for model ", {{mod_num}}, " including qq plot for the residuals, overall model fit, and fit for the year effect."), cache = TRUE}
...
```{r rootgram-model-{{mod_num}}-fall, fig.height = 5, fig.width = 5, fig.cap = paste0("Hanging rootgram for fall model ", {{mod_num}}, "."), cache = TRUE}
